...
if ( ! class_exists( 'ic_Woo_Manage_addons' ) ) {
	class ic_Woo_Manage_addons{
		private $token;
		...
		public $plugin_key  =   "ic-woo-manage-addons";
			...
			<div class="ic_plugins_container">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/assets/images/enterprise_edition.jpg" alt="WooCommerce Advance Sales Report (Enterprise Edition)" />
							</div>
							<div class="ic_plugin_content">
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/assets/images/job-manager.jpg" alt="WooCommerce Job Manager" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/assets/images/sales_trends_analysis.jpg" alt="WooCommerce Sales Trends Analysis" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/assets/images/audit-log-pro.jpg" alt="WooCommerce Audit Log Pro" />
							</div>
